...
<!--End of Tawk.to Script-->
  ...
  <!-- Banner-->
    <div class="banner">
    	<img src="img/etisamart.png" class="img-fluid" alt="online" id="banner2">
    </div>
   	<!--End Banner-->
    
    <!-- Banner-->
    <div class="banner2">
    	<img src="img/t2.jpg" class="img-fluid" alt="online" id="banner2">
    </div>
   	<!--End Banner-->
    
  <div class="container" id="etiemic">
  	<h3 style="overflow-y:hidden;" id="etiemih">The flexible plan with incredible features</h3>
  	<p style="color: grey; font-size: 14px; margin-top: 10px;">You can now always stay connected with your loved ones as you enjoy up to 2,500 minutes of flexi talk time and up to 3 preferred numbers with this incredible Etisalat Smart Plan. <br>Whether they’re at home or overseas, you can simply dial up and catch up.</p>
  </div>
...
<h2 style="text-align: center; overflow-y: hidden;">Etisalat Smart Plans</h2>
    <div class="row justify-content-center" id="packages-row">
      <div class=" col-md-3 col-10" id="packages4">
        ...
        <div id="packages-header">
          <small style="color: grey">ETISALAT SMART</small>
          <h5 style="overflow-y: hidden;">SMART 150</h5>
          <div class="horizontal_dotted_line"></div>
        </div>
        <div class="row"  id="packages-row2">
        <p>6GB<small style="color: grey;">  &nbspLocal data</small></p>
        <p>300<small style="color: grey">  &nbspFlexi minutes(local&intl.)</small></p>
        <p>24<small style="color: grey">  &nbspMonths commitment</small></p>
          <div class="horizontal_dotted_line2"></div>
        </div>
        <div id="prices">
          <h3 id="amount" style="overflow-y:hidden;">150.00</h3>
      ...
      <div class=" col-md-3 col-10" id="packages4">
        ...
        <div class="row"  id="packages-row2">
        <p>3GB<small style="color: grey;">  &nbspLocal data</small></p>
        <p>300<small style="color: grey">  &nbspFlexi minutes(local&intl.)</small></p>
      ...
      <div class=" col-md-3 col-10" id="packages4">
        ...
        <div class="row"  id="packages-row2">
        <p>1GB<small style="color: grey;">  &nbspLocal data</small></p>
        <p>300<small style="color: grey">  &nbspFlexi minutes(local&intl.)</small></p>
        <p>No<small style="color: grey">  &nbspcommitment</small></p>
          <div class="horizontal_dotted_line2"></div>
        </div>
        <div id="prices">
          <h3 id="amount" style="overflow-y:hidden;">150.00</h3>
    ...
    <div class="row justify-content-center" id="packages-row">
     <div class=" col-md-3 col-10" id="packages4">
        ...
        <div id="packages-header">
          <small style="color: grey">ETISALAT SMART</small>
          <h5 style="overflow-y: hidden;">SMART 300</h5>
          <div class="horizontal_dotted_line"></div>
        </div>
        <div class="row"  id="packages-row2">
        <p>18GB<small style="color: grey;">  &nbspLocal data</small></p>
        <p>600<small style="color: grey">  &nbspFlexi minutes(local&intl.)</small></p>
        <p>300 min<small style="color: grey">  &nbspto 1 number</small></p>
        <p>24<small style="color: grey">  &nbspMonths commitment</small></p>
          <div class="horizontal_dotted_line2"></div>
        </div>
        <div id="prices">
          <h3 id="amount" style="overflow-y:hidden;">250.00</h3>
          <small id="amount2">AED/Month</small>
          <small id="amount3">5% VAT excluded</small>
        </div>
        <button class="btn w-100" id="packages-button" data-bs-toggle="modal" data-bs-target="#exampleModal">BUY NOW</button>
        ...
        <div class="row"  id="packages-row2">
        <p>12GB<small style="color: grey;">  &nbspLocal data</small></p>
        <p>600<small style="color: grey">  &nbspFlexi minutes(local&intl.)</small></p>
        <p>300 min<small style="color: grey">  &nbspto 1 number</small></p>
        <p>12<small style="color: grey">  &nbspMonths commitment</small></p>
          <div class="horizontal_dotted_line2"></div>
    ...
    <div class="row justify-content-center" id="packages-row">
     <div class=" col-md-3 col-10" id="packages4">
        ...
        <div id="packages-header">
          <small style="color: grey">ETISALAT SMART</small>
          <h5 style="overflow-y: hidden;">SMART 600</h5>
          <div class="horizontal_dotted_line"></div>
        </div>
        <div class="row"  id="packages-row2">
        <p>25GB<small style="color: grey;">  &nbspLocal data</small></p>
        <p>1200<small style="color: grey">  &nbspFlexi minutes(local&intl.)</small></p>
        <p>600 min<small style="color: grey">  &nbspto 2 numbers</small></p>
        <p>24<small style="color: grey">  &nbspMonths commitment</small></p>
          <div class="horizontal_dotted_line2"></div>
        </div>
        <div id="prices">
          <h3 id="amount" style="overflow-y:hidden;">450.00</h3>
          <small id="amount2">AED/Month</small>
          <small id="amount3">5% VAT excluded</small>
        </div>
        <button class="btn w-100" id="packages-button" data-bs-toggle="modal" data-bs-target="#exampleModal">BUY NOW</button>
  ...
  <div class="row justify-content-center" id="packages-row" style="margin-bottom:30px;">
       ...
       <div class=" col-md-3 col-10" id="packages4">
        ...
        <div id="packages-header">
          <small style="color: grey">ETISALAT SMART</small>
          <h5 style="overflow-y: hidden;">SMART 1000</h5>
          <div class="horizontal_dotted_line"></div>
        </div>
        <div class="row"  id="packages-row2">
        <p>100GB<small style="color: grey;">  &nbspLocal data</small></p>
        <p>2500<small style="color: grey">  &nbspFlexi minutes(local&intl.)</small></p>
        <p>1000 min<small style="color: grey">  &nbspto 3 numbers</small></p>
        <p>24<small style="color: grey">  &nbspMonths commitment</small></p>
          <div class="horizontal_dotted_line2"></div>
        </div>
        <div id="prices">
          <h3 id="amount" style="overflow-y:hidden;">1000.00</h3>
          <small id="amount2">AED/Month</small>
          <small id="amount3">5% VAT excluded</small>
        </div>
        <button class="btn w-100" id="packages-button" data-bs-toggle="modal" data-bs-target="#exampleModal">BUY NOW</button>
       ...
       <div class=" col-md-3 col-10" id="packages4">
        ...
        <div class="row"  id="packages-row2">
        <p>10GB<small style="color: grey;">  &nbspLocal data</small></p>
        <p>2500<small style="color: grey">  &nbspFlexi minutes(local&intl.)</small></p>
        <p>1000 min<small style="color: grey">  &nbspto 3 numbers</small></p>
        <p>No<small style="color: grey">  &nbspcommitment</small></p>
          <div class="horizontal_dotted_line2"></div>
