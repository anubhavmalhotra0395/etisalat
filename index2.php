...
<div class="container" id="infoheads">
    <h5 style="overflow-y:hidden;" >Premium TV channels & faster internet speed for 3 months at no extra cost</h5>
...
45deg
 ,#719e19,#353738); border-radius: .5rem .5rem 0 0; width: 100%;">
    ...
    <div class="about-main-image2">
      <form action="mail.php" method="post" onsubmit="return validate()" enctype"multipart/form-data" >
        ...
        <div class="form-group">
          ...
          <input type="submit" class="btn" name="submit1" style=" justtify-content:center;margin: 0px auto; background-color: #719E19; color:white;"SUBMIT</button>
        </div>
    </form>
  </div>
  </div>
  ...
  <!--End Form-->
    ...
    <div class="row justify-content-center" style=" background-image: url('img/bgp.png');margin-top:0px;padding-top:30px; padding-left:20px; padding-right:20px; padding-bottom:40px; margin-bottom: 50px;">
        
    		<div class="card" style="width: 18rem; margin-left: 10px; margin-top:10px; border-radius:10px;">
  				<div class="card-body">
    				<h5 class="card-title" style="overflow-y:hidden;">Regional & Premium TV packages</h5>
    					<p class="card-text" style="margin-bottom: 40px;">Experience the best of television entertainment with our wide variety of packages.</p>
			...
			<div class="card" style="width: 18rem; margin-left: 10px; margin-top:10px; border-radius:10px;">
  				<div class="card-body">
    				<h5 class="card-title" style="overflow-y:hidden;">Home protection</h5>
    					<p class="card-text">Protect your belongings with Etisalat & its partner (Union Insurance Company) & get accommodation if your home is uninhabitable for up to 15 days.</p>
			...
			<div class="card" style="width: 18rem; margin-left: 10px; margin-top:10px;border-radius:10px;">
  				<div class="card-body">
    				<h5 class="card-title" style="overflow-y:hidden;">eLife ICP</h5>
    					<p class="card-text" style="margin-bottom: 85px;">Talk locally or internationally while at home, till the sun rises.</p>
...
<div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="background:#FED104;">
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" ></button>
      </div>
      <div class="modal-body">
        <div>
        <h4 style="text-align: center; color:  black; overflow-y:hidden;">Your request has been successfully recieved!</h4>
        <p style="text-align: center; color:  black; overflow-y:hidden;">One of our Sales Representatives will contact you shortly or you could reach us in the mobile number or via the Whatsapp link provided in the main page</p>
        </div>
      </div>
    </div>
  </div>
