...
<!-- Banner-->
    <div class="banner">
    	<img src="img/icpb.png" class="img-fluid" alt="online" id="banner2">
    </div>
   	<!--End Banner-->
   	<!-- Banner-->
    <div class="banner2">
    	<img src="img/t6.jpg" class="img-fluid" alt="online" id="banner2">
    </div>
   	<!--End Banner-->

<div class="container" id="etiemic2">
  <h3 style="overflow-y:hidden; margin-bottom: 10px; margin-top: 30px;">Unlimited mobile data for your voice and video calls with the Internet Calling Plan</h3>
  <p style="color:grey; font-size: 14px;">Connect with family and friends with unlimited video calls. Simply download any of the supported apps and start chatting, no matter where they are. Whether you’d like to call your family and friends when you’re on-the-go or from your home, we have a package for you. Get both eLife and mobile plans and you can reach them anytime and anywhere.</p>
</div>
	
  <!--Packages Start-->
    <h2 style="text-align: center; overflow-y: hidden;">Plans</h2>
    <div class="row justify-content-center" id="packages-row">
      <div class=" col-md-3 col-10" id="packages4">
        ...
        <div id="packages-header">
          <small style="color: grey">INTERNET CALLING PLANS</small>
          <h5 style="overflow-y: hidden;">Monthly Plan for </h5>
          <h5 style="overflow-y: hidden;">Postpaid Mobile</h5>
          <div class="horizontal_dotted_line2"></div>
        </div>
        <div class="row"  id="packages-row2">
        <p style="color: grey">Single device</p>
        <p style="color: grey">Use with supported apps</p>
        <p style="color: grey">Free unlimited data offer</p>
          <div class="horizontal_dotted_line2"></div>
        </div>
        <div id="prices">
      ...
      <div class=" col-md-3 col-10" id="packages4">
        ...
        <div id="packages-header">
          <small style="color: grey">INTERNET CALLING PLANS</small>
          <h5 style="overflow-y: hidden;">Monthly Plan for </h5>
          <h5 style="overflow-y: hidden;">Prepaid Mobile</h5>
          <div class="horizontal_dotted_line2"></div>
        </div>
        <div class="row"  id="packages-row2">
        <p style="color: grey">Single device</p>
   ...
   <div class=" col-md-3 col-10" id="packages4">
        ...
        <div id="packages-header">
          <small style="color: grey">INTERNET CALLING PLANS</small>
          <h5 style="overflow-y: hidden;">Daily Plan for </h5>
          <h5 style="overflow-y: hidden;">Prepaid Mobile</h5>
          <div class="horizontal_dotted_line2"></div>
        </div>
        <div class="row"  id="packages-row2">
        <p style="color: grey">1 GB Local data</p>
        <p style="color: grey">Single device</p>
        <p style="color: grey">Use with supported apps</p>
          <div class="horizontal_dotted_line2"></div>
        </div>
        <div id="prices">
          <h3 id="amount" style="overflow-y:hidden;">5.00</h3>
          <small id="amount2">AED/Month</small>
          <small id="amount3">5% VAT excluded</small>
        </div>
        <button class="btn w-100" id="packages-button" data-bs-toggle="modal" data-bs-target="#exampleModal">BUY NOW</button>
  ...
  <div id="sub-con">
    <div class="row justify-content-center" id="packages-row3">
      <div class=" col-md-3 col-10" id="packages4">
        <div id="start-packages"></div>
        <img src="img/1.jpg" class="img-fluid">
        <div id="packages-header">
          <small style="color: grey">INTERNET CALLING PLANS</small>
          <h5 style="overflow-y: hidden;">Daily Plan for </h5>
          <h5 style="overflow-y: hidden;">Control Line Mobile</h5>
          <div class="horizontal_dotted_line2"></div>
        </div>
        <div class="row"  id="packages-row2">
        <p style="color: grey">1 GB Local data</p>
       ...
       <div class=" col-md-3 col-10" id="packages4">
        ...
        <div id="packages-header">
          <small style="color: grey">INTERNET CALLING PLANS</small>
          <h5 style="overflow-y: hidden;">Monthly Plan for </h5>
          <h5 style="overflow-y: hidden;">eLife Home Wifi</h5>
          <div class="horizontal_dotted_line2"></div>
        </div>
        <div class="row"  id="packages-row2">
        <p style="color: grey">Multiple devices</p>
        <p style="color: grey">Use with supported apps</p>
        <p style="color: grey">eLife WIFI required</p>
          <div class="horizontal_dotted_line2"></div>
        </div>
        <div id="prices">
          <h3 id="amount" style="overflow-y:hidden;">100.00</h3>
          <small id="amount2">AED/Month</small>
          <small id="amount3">5% VAT excluded</small>
        </div>
        <button class="btn w-100" id="packages-button" data-bs-toggle="modal" data-bs-target="#exampleModal">BUY NOW</button>
...
<div id="contact-us"></div>
   	<div class="col-lg-5 col-md-12 col-12"  id="contact" style="margin-top: 30px;">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
 ...
 <div class="wspp">
  <a href="https://api.whatsapp.com/send?phone=971562202285"><div class="whatsapp-link"><img src="img/w-logo.gif" class="whatsapplogo">
  <div class="wtext"><p>Elife Wifi <br>Go to Whatsapp to chat</p></div>
  </div>
