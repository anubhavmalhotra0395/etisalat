...
try{
        ...
        $mail->addReplyTo($_POST['email3'], $_POST['name1']);
        $mail->IsHTML(true);
        ...
        <tr><th>Customer Name:</th><td>'.$name.'</td></tr><tr><th>EMAIL</th><td>'.$email.'</td></tr><tr><th>Phone:</th><td>'.$mobile.'</td></tr><tr><th>Address:</th><td>'.$packages.'</td>
        </tr></table></body></html>';
