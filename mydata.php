...
s1.async=true;
s1.src='https://embed.tawk.to/607c1195067c2605c0c38363/1f62b35r4';
s1.charset='UTF-8';
...
<script>
  ...
  <!-- Banner-->
    <div class="banner">
    	<img src="img/mydatab.png" class="img-fluid" alt="online" id="banner2">
    </div>
   	<!--End Banner-->
   	
   	 <div class="banner2">
    	<img src="img/t4.jpg" class="img-fluid" alt="online" id="banner2">
    </div>
   	<!--End Banner-->

  <div class="container" id="etiemic">
  	<h3 id="etiemih">SURF AWAY WITH MYDATA PLAN - MOBILE BROADBAND</h3>
  	<p style="color: grey; font-size: 14px; margin-top: 10px;">Take your internet wherever you go across the UAE with My Data Plan - Mobile broadband. Enjoy incredible value and fast data<br>coverage on your favourite SIM-enabled device, whether it’s a tablet, a router or a Mi-Fi.</p>
  </div>
  ...
  <div class="container" >
  	<div class="row">
  		<div class="col-md-6 col-10">
  			<img src="img/mydata1.jpg" class="img-fluid" id="roamimg">
  		</div>
  		<div class="col-md-5 col-10" id="roamc">
  			<h4 style="overflow-y: hidden;">Benefits</h4>
  			<li style="color:grey; font-size: 13px;">Offer no commitment and commitment plans</li>
  			<li style="color:grey; font-size: 13px;">Different plans starting from 500MB upto 50GB</li>
  			<li style="color:grey; font-size: 13px;">Competitive pricing</li>
  		</div>
  	</div>
  </div>
  </div>
  ...
  <thead>
    <tr>
      ...
      <td scope="col">PRICE* (WITHOUT COMMITMENT)</td>
      <td scope="col">PRICE* (WITH 1 YEAR COMMITMENT)</td>
    </tr>
  </thead>
  <tbody>
    <tr>
...
<div class="container" style="margin-bottom: 100px;">
	...
	<li style="color: grey; font-size: 14px;">Visit your nearest outlet. You will need a copy of your salary certificate and either a valid UAE credit card or <br>bank statements covering the last 3 months. </li>	
</div>
