...
<script>
  ...
  <!-- Banner-->
    <div class="banner">
    	<img src="img/newpostpaid.png" class="img-fluid" alt="online" id="banner2">
    </div>
   	<!--End Banner-->
   	
   	<!-- Banner-->
    <div class="banner2">
    	<img src="img/t5.jpg" class="img-fluid" alt="online" id="banner2">
    </div>
   	<!--End Banner-->

  <div class="container" id="etiemic">
  	<h3 id="etiemih">Great value plans that suit your mobile needs</h3>
  	<p style="color: grey; font-size: 14px; margin-top: 10px;">Enjoy amazing minutes, data and SMS rates in the UAE and experience the convenience and flexibility of saving add-ons <br>that allow you to further customise your plan.</p>
  </div>
...
<h2 style="text-align: center; overflow-y: hidden;">New Postpaid Plans</h2>
    <div class="row justify-content-center" id="packages-rown">
      <div class=" col-md-3 col-10" id="packages4">
        <div id="start-packages"></div>
        <img src="img/1.jpg" class="img-fluid">
        <div id="packages-header">
          <small style="color: grey">NEW POSTPAID</small>
          <h5 style="overflow-y: hidden;">NEW POSTPAID 150</h5>
          <div class="horizontal_dotted_line"></div>
        </div>
        <div class="row"  id="packages-row2">
        <p>6GB<small style="color: grey;">  &nbspLocal data</small></p>
        <p>200<small style="color: grey">  &nbspFlexi minutes(local&intl.)</small></p>
        <p>20<small style="color: grey">  &nbspUAE Wi-fi hours</small></p>
       ...
       <div class=" col-md-3 col-10" id="packages4">
        ...
        <div class="row"  id="packages-row2">
        <p>6GB<small style="color: grey;">  &nbspLocal data</small></p>
        <p>500<small style="color: grey">  &nbspLocal minutes(local&intl.)</small></p>
        <p>20<small style="color: grey">  &nbspUAE Wi-fi hours</small></p>
        <p>24<small style="color: grey">  &nbspMonths commitment</small></p>
          <div class="horizontal_dotted_line2"></div>
        </div>
    ...
    <div class="row justify-content-center" id="packages-row">
      <div class=" col-md-3 col-10" id="packages4">
        ...
        <div class="row"  id="packages-row2">
        <p>12GB<small style="color: grey;">  &nbspLocal data</small></p>
        <p>1000<small style="color: grey">  &nbspLocal minutes(local&intl.)</small></p>
        <p>30<small style="color: grey">  &nbspUAE Wi-fi hours</small></p>
        <p>12<small style="color: grey">  &nbspMonths commitment</small></p>
          <div class="horizontal_dotted_line2"></div>
        </div>
       ...
       <div class=" col-md-3 col-10" id="packages4">
        ...
        <div id="packages-header">
          <small style="color: grey">NEW POSTPAID</small>
          <h5 style="overflow-y: hidden;">NEW POSTPAID 500</h5>
          <div class="horizontal_dotted_line"></div>
        </div>
        <div class="row"  id="packages-row2">
        <p>25GB<small style="color: grey;">  &nbspLocal data</small></p>
        <p>750<small style="color: grey">  &nbspFlexi minutes(local&intl.)</small></p>
        <p>30<small style="color: grey">  &nbspUAE Wi-fi hours</small></p>
        <p>12<small style="color: grey">  &nbspMonths commitment</small></p>
          <div class="horizontal_dotted_line2"></div>
        </div>
        <div id="prices">
          <h3 id="amount" style="overflow-y:hidden;">500.00</h3>
          <small id="amount2">AED/Month</small>
          <small id="amount3">5% VAT excluded</small>
        </div>
        <button class="btn w-100" id="packages-button" data-bs-toggle="modal" data-bs-target="#exampleModal">BUY NOW</button>
       ...
       <div class=" col-md-3 col-10" id="packages4">
        ...
        <div class="row"  id="packages-row2">
        <p>12GB<small style="color: grey;">  &nbspLocal data</small></p>
        <p>2000<small style="color: grey">  &nbspLocal minutes(local&intl.)</small></p>
        <p>30<small style="color: grey">  &nbspUAE Wi-fi hours</small></p>
        <p>12<small style="color: grey">  &nbspMonths commitment</small></p>
          <div class="horizontal_dotted_line2"></div>
        </div>
    ...
    <div class="row justify-content-center" id="packages-row" style="margin-bottom:30px;">
      <div class=" col-md-3 col-10" id="packages4">
        ...
        <div id="packages-header">
          <small style="color: grey">NEW POSTPAID</small>
          <h5 style="overflow-y: hidden;">NEW POSTPAID 1000</h5>
          <div class="horizontal_dotted_line"></div>
        </div>
        <div class="row"  id="packages-row2">
        <p>100GB<small style="color: grey;">  &nbspLocal data</small></p>
        <p>1000<small style="color: grey">  &nbspFlexi minutes(local&intl.)</small></p>
        <p>30<small style="color: grey">  &nbspUAE Wi-fi hours</small></p>
        <p>12<small style="color: grey">  &nbspMonths commitment</small></p>
          <div class="horizontal_dotted_line2"></div>
        </div>
      ...
      <div class=" col-md-3 col-10" id="packages4">
       ...
       <div class=" col-md-3 col-10" id="packages4">
        ...
        <div id="packages-header">
          <small style="color: grey">NEW POSTPAID</small>
          <h5 style="overflow-y: hidden;">MONTHLY PLAN</h5>
          <div class="horizontal_dotted_line"></div>
        </div>
        <div class="row"  id="packages-row2">
        <p>100mb<small style="color: grey;">  &nbspLocal data</small></p>
        <p>50<small style="color: grey">  &nbspFlexi minutes(local&intl.)</small></p>
          <div class="horizontal_dotted_line5"></div>
        </div>
        <div id="prices">
          <h3 id="amount" style="overflow-y:hidden;">50.00</h3>
          <small id="amount2">AED/Month</small>
          <small id="amount3">5% VAT excluded</small>
        </div>
       <button class="btn w-100" id="packages-button" data-bs-toggle="modal" data-bs-target="#exampleModal">BUY NOW</button>
