...
<!--End of Tawk.to Script-->
  ...
  <!-- Banner-->
    <div class="banner">
    	<img src="img/premiumpp.png" class="img-fluid" alt="online" id="banner2">
    </div>
   	<!--End Banner-->
   	
   	<!-- Banner-->
    <div class="banner2">
    	<img src="img/t8.jpg" class="img-fluid" alt="online" id="banner2">
    </div>
   	<!--End Banner-->

  <div class="container" id="etiemic">
  	<h3 id="etiemih">Gold and platinum plans for your lifestyle</h3>
  	<p style="color: grey; font-size: 14px; margin-top: 10px;">More than just an incredible connectivity package, these premium plans were specially tailored to keep you ahead, while also treating you to exclusive benefits, including an exceptional number <br>and dedicated customer care service.</p>
  </div>
  ...
  <thead>
    <tr>
      <td scope="col">PACK</th>
      <td scope="col">GOLD PLAN 500</td>
      <td scope="col">GOLD PLAN 500</td>
      <td scope="col">PLATINUM PLAN 1,000</td>
      <td scope="col">PLATINUM PLAN 1,000</td>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td scope="row">Price (AED) (VAT excluded)</td>
      <td>500.00 AED</td>
      <td>500.00 AED</td>
      <td>1000.00 AED</td>
      <td>1000.00 AED</td>
    ...
    <tr>
      <td scope="row">Premium Number</td>
      <td>Gold Number</td>
      <td>Gold Number</td>
      <td>Platinum Number</td>
      <td>Platinum Number</td>
    </tr>
    <tr>
      <td scope="row">Local Data</td>
      <td>75GB</td>
      <td>75GB</td>
      <td>150GB</td>
      <td>150GB</td>
     ...
     <tr>
      <td scope="row">Minutes</td>
      <td>750 flexi minutes</td>
      <td>2,000 local minutes</td>
      <td>1,000 flexi minutes</td>
      <td>2,000 local minutes</td>
    </tr>  

     <tr>
      <td scope="row">Commitment</td>
      <td>24-month</td>
      <td>24-month</td>
      <td>24-month</td>
      <td>24-month</td>
